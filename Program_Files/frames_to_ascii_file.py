...
def main(master):
    ...
    entry_widget_arguments = {'directory': {'button_text': 'Directory', 'initial_dir': extracted_frames_path},
                              ...
                              'frame_width': {'label_text': 'Frame Width', 'default_value': 'auto', 'dtype': 'i++',
                                              'auto': True}}
    entry_widget_types = {'directory': cw.FolderDialog,
                          'mode': cw.RadioButton,
                          'scale': cw.Entry,
    ...
    run_button = cw.Button(master, row_color=row_color, button_text='Run',
                           command=partial(pf.check_settings, entry_widgets,
                                           partial(pf.convert_to_ascii, row_color=row_color, master=master)))
